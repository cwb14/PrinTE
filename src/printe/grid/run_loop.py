...
Run it under nohup so it survives ssh logout:
    ...
    nohup python -m printe.grid.run_loop \\
        --target-hits 200 \\
        --max-rounds 50 \\
...
# Reuse grid_utils' dir-name format so run_loop and guided_search agree on
# parameter directory names.
from .grid_utils import dir_name_from_combo
